...
public class UseDDParam extends HttpServlet {
	...
	/////////////////////////////////////////////////////////////////////////////
	      		// init-param : 다른 서블릿에서 사용 할 수 없다.
	      		out.println("<div style='width:350px; height:250px; border:1px solid #FF0000'>");
	      		out.println("<h2>다른 서블릿에 init-param 사용</h2>");
	      		//1. ServletConfig 얻기
	      		ServletConfig sc= getServletConfig();
	      		out.println("<strong>이름</strong>");
	      		out.println(sc.getInitParameter("name"));
	      		out.println("<br/>");
	      		out.println("<a href='use_init_param'>init-param정의 서블릿</a>");
	      		
	      		out.print("</div>");
	      		
	      		//context-param : 모든 서블릿에서 사용 할 수 없다.
	      		out.println("<div style='width:350px; height:250px; border:1px solid #0000FF'>");
	      		out.println("<h2>다른 서블릿에서 context-param 사용</h2>");
	      		//1. ServletContext 얻기
	      		ServletContext sc1= getServletContext();
	      		out.println("<strong>이름</strong>");
	      		out.println(sc1.getInitParameter("name"));
	      		out.println("<br/>");
