...
public class WhySessionC extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    //WhySessionC 서블릿에서는 이전페이지인 WhySessionB 서블릿내의 값을
	    //사용할 수 없다.(이전 페이지에서 사용한 이름을 이동한 페이지에서 사용할 수 없다.)
	      //String name= request.getParameter("name"); <- 권장 X
	      //out.println(name+" 님의 작업페이지 입니다.");
