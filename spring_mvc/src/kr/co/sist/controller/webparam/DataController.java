...
public class DataController {
	...
	//JSP로 전달하기위해서 scope객체를 매개변수로 받는다.
	//HttpServletRequest는 POJO형식의 클래스가 아니게 되므로 권장하지않는다.
	public String useRequest( HttpServletRequest request){
		...
		//공지사항을 조회아여 JSP로 전달한다. (scope 객체 사용)
	...
	public ModelAndView useModelAndView( ){//매개변수 없다.
