...
class UseCasting {
	public static void main(String[] args) {
		...
		byte result = (byte)(b1+b2);//연산의 결과가 int로 자동형변환 되는 것을 byte로 경제형 변환
		...
		//long l = (long)2147483648;//상수값이 literal 보다 크다면 casting을 실행하기전에 Error 발생.

		int i =(int)f1;//값손실 발생(실수부의 값이 모두 사라져서 할당됨)
...
//		int i =(int)s;//기본형
		...
		boolean b = true;
//		i =(int)b;  //error
		boolean bc = (boolean)b;         //되긴 되나 의미없는 짓임. 나를 나로 바꾸는 것은 의미없음
