...
<table id="writeTab">
	...
	<tr>
		...
		<td style="width:400px">
			<input type="text" name="e_year" class="inputBox"	style="width: 40px"
				readonly="readonly" value="${ param.param_year }"/>-
			<input type="text" name="e_month" class="inputBox"	style="width: 20px"
				readonly="readonly" value="${ param.param_month }"/>-
			<input type="text" name="e_day" class="inputBox"	style="width: 20px"
