...
$(function(){
	$("#btn").click(function(){
		...
		//확장자가 jsp,java,class,xml은 업로드하지 못하도록 막는다.(대문자일경우도 막아야됨)
...
<div id="wrap">
	...
	<form action="mr_upload_process.jsp" id="uploadFrm"method="post" enctype="multipart/form-data" ><!-- enctype=multi어쩌구가없으면
	파라미터 값을 전달을 못해줘서 다시 기본 form화면으로 되돌아온다. 있으면 값이전달이 잘됨.-->
	<label>이름</label>
