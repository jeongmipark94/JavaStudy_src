...
/**
 * static (class) 변수 : 어떤 객체에도 속해있지 않은 공용 변수
 *  클래스가 실행되면 가장 처음 메모리(method)에 올라가고 모든 객체가 
 *  하나의 변수를 참조하여 사용한 변수.
 *  
 * ex ) 집전화
 * 
...
public class UseStaticVariable {
	public static int i ; //static variable -> 바로사용
